    ...
    <header className="sticky top-0 z-50 border-b border-konarr-line/70 bg-konarr-base/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        <Link href="/" className="group inline-flex items-center gap-3">
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-konarr-line bg-konarr-panel text-sm font-semibold text-konarr-accent">
            K
          </span>
          <div>
            <p className="text-base font-semibold tracking-wide text-konarr-text">Konarr</p>
